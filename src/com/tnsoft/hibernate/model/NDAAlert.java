...
public class NDAAlert implements Serializable {
	...
	public String toString() {
		return "NDAAlert [id=" + id + ", domainId=" + domainId + ", tagNo=" + tagNo + ", alertLevel=" + alertLevel
				+ ", creationTime=" + creationTime + ", lastModitied=" + lastModitied + ", status=" + status + ", csn="
				+ csn + ", expressId=" + expressId + ", statusName=" + statusName + ", time=" + time + ", express="
				+ express + ", mobile=" + mobile + ", userName=" + userName + ", alertName=" + alertName + "]";
	}
