...
public class LoginAuthenticationFilter extends UsernamePasswordAuthenticationFilter {
    ...
    protected void successfulAuthentication(HttpServletRequest request, HttpServletResponse response, Authentication authResult) throws IOException, ServletException {
        ...
        try{
            ...
            session.setAttribute("roleId", lg.getDefRole().getRoleId());
    ...
    private void addCookie(String name, String value, boolean flag, HttpServletResponse response, HttpServletRequest request) throws UnsupportedEncodingException {
        ...
        Logger.error("Add Cookie");
    }
    
    /*
    private void addCookie(String name, String password, boolean rememberMe, HttpServletResponse response, HttpServletRequest request) throws UnsupportedEncodingException {
